...
export function EndOfLifeHero() {
  return (
    <section
      className="relative min-h-screen flex items-center pt-32 overflow-hidden bg-gradient-to-br from-rose-900 via-rose-800/50 to-slate-900 bg-cover bg-center"
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-500 mb-10 leading-relaxed max-w-3xl mx-auto animate-slide-up animation-delay-400">
            Compassionate palliative and hospice care focusing on comfort,
            dignity, and quality of life. Professional support for patients and
            families.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up animation-delay-500">
            ...
            >
              <Button
                size="lg"
                className="text-base font-semibold bg-gradient-to-r from-rose-500 to-pink-600 hover:shadow-2xl hover:shadow-rose-500/30 hover:scale-105 transition-all duration-300 group"
              >
                Get Support Today
