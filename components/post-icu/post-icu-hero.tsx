...
export function PostICUHero() {
  return (
    <section className="relative min-h-screen flex items-center pt-32 overflow-hidden bg-gradient-to-br from-primary/20 via-primary/10 to-slate-900">
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 border border-primary/30 text-primary/80 px-4 py-2 rounded-full text-sm font-medium mb-8 animate-slide-up animation-delay-200">
