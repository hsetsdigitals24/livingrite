...
export function CorporateWellnessHero() {
  return (
    <section
      className="relative min-h-screen flex items-center pt-32 overflow-hidden bg-gradient-to-br from-indigo-900 via-indigo-800/50 to-slate-900 bg-cover bg-center"
    ...
    >
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 border border-indigo-400 text-indigo-400 px-4 py-2 rounded-full text-sm font-medium mb-8 animate-slide-up animation-delay-200">
          ...
          <p className="text-lg md:text-xl text-gray-500 mb-10 leading-relaxed max-w-3xl mx-auto animate-slide-up animation-delay-400">
            Comprehensive wellness programs and health consultations tailored to
            your organization. Improve employee health, engagement, and
            productivity.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up animation-delay-500">
            <Link
              href={process.env.CALENDLY_URLINK || "https://calendly.com/clientservices-livingritecare/30min"}
              target="_blank"
              rel="noreferrer"
            ...
            >
              <Button
                size="lg"
                className="cursor-pointer text-base font-semibold bg-gradient-to-r from-indigo-500 to-blue-600 hover:shadow-2xl hover:shadow-indigo-500/30 hover:scale-105 transition-all duration-300 group"
              >
                Book a Consultation
