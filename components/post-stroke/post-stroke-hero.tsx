...
export function PostStrokeHero() {
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-linear-to-br from-slate-900 via-emerald-900/20 to-slate-900">
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-24 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            {/* Announcement Badge */}
            <div className="inline-flex items-center gap-2 bg-blue-500/20 border border-blue-500/30 text-blue-300 px-4 py-2 rounded-full text-sm font-medium mb-8 animate-slide-up animation-delay-200">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight animate-slide-up animation-delay-300">
              Expert <span className="bg-linear-to-r from-blue-400 via-emerald-400 to-cyan-400 bg-clip-text text-transparent">Post-Stroke Recovery</span> at Home
            </h1>
              ...
              {[
                ...
                return (
                  <div key={idx} className="text-center">
                    <div className="inline-flex p-3 rounded-lg bg-emerald-500/20 mb-3">
                      <Icon className="w-6 h-6 text-emerald-400" />
                    </div>
                    <div className="text-sm text-gray-400 mb-1">{feature.label}</div>
                    <div className="text-sm font-semibold text-emerald-300">{feature.value}</div>
                  </div>
                )
              })}
            </div>
          ...
          <div className="hidden lg:flex items-center justify-center relative animate-slide-up animation-delay-300">
            <div className="relative w-full max-w-md">
              {/* Gradient Card */}
              <div className="aspect-square rounded-3xl bg-linear-to-br from-emerald-500/30 to-blue-500/30 backdrop-blur-sm border border-white/10 overflow-hidden shadow-2xl">
