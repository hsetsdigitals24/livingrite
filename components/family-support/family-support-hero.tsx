...
export function FamilySupportHero() {
  return (
    <section
      className="relative min-h-screen flex items-center pt-32 overflow-hidden bg-gradient-to-br from-cyan-900 via-cyan-800/50 to-slate-900 bg-cover bg-center"
    ...
    >
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 border border-cyan-500 text-cyan-500 px-4 py-2 rounded-full text-sm font-medium mb-8 animate-slide-up animation-delay-200">
          ...
          <p className="text-lg md:text-xl text-gray-500 mb-10 leading-relaxed max-w-3xl mx-auto animate-slide-up animation-delay-400">
            Respite care and professional counseling to help caregivers maintain
            their wellbeing. Comprehensive support for families during
            challenging times.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up animation-delay-500">
            ...
            >
              <Button
                size="lg"
                className="cursor-pointer text-base font-semibold bg-gradient-to-r from-cyan-500 to-sky-600 hover:shadow-2xl hover:shadow-cyan-500/30 hover:scale-105 transition-all duration-300 group"
              >
                Get Family Support
