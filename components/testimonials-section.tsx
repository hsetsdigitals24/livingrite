  ...
  return (
    <section id="testimonials" className="py-20 lg:py-28 bg-linear-to-br from-white via-gray-50 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-0 right-1/3 w-96 h-96 bg-teal-400 rounded-full mix-blend-multiply filter blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="max-w-2xl mx-auto mb-12 animate-slide-up animation-delay-400">
          <Card className="border-gray-300 bg-white relative overflow-hidden">
            {/* Quote Mark */}
            <div className="absolute top-6 left-6 text-6xl text-emerald-200 opacity-20">
              <span>"</span>
            </div>
          ...
          <div className="flex items-center justify-between mt-8">
            <Button
              ...
              variant="outline"
              size="lg"
              className="p-3 h-auto border-gray-300 text-gray-600 hover:bg-gray-100 hover:text-emerald-600 transition-colors duration-300"
            >
            ...
            <Button
              onClick={goToNext}
              size="lg"
              className="p-3 h-auto bg-linear-to-r from-emerald-500 to-teal-600 hover:shadow-lg hover:shadow-emerald-500/20 transition-all duration-300"
            >
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="aspect-square bg-linear-to-br from-gray-800/40 to-gray-900/40 p-4 flex flex-col justify-center items-center text-center hover:bg-gray-800/60 transition-all duration-300 group">
                <div className="w-12 h-12 rounded-full bg-linear-to-br from-emerald-500 to-teal-600 flex items-center justify-center mb-2">
